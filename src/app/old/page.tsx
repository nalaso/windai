...
export default function Home() {
  ...
  const generateCode = async () => {
    setLoading(true);
    // handleSubmit()
    const promised = [generateSimpleCode()];
  ...
  return (
    <main className="bg-white min-h-screen px-4">
      ...
      <div className="w-6/12 mx-auto p-3 rounded-2xl bg-gray-400 flex my-5 shadow-lg gap-5 items-center">
        <Input
          type="text"
        ...
        <div className="w-full mb-20">
          ...
          <div className="w-10/12 mt-20 m-auto">
            ...
            <div className="overflow-auto">
              <PreviewScreen html_code={simpleCode} />
            </div>
          </div>
        </div>
      </div>
